...
def InceptionV4(num_classes=1001, dropout_keep_prob=0.5, weights=None, include_top=True):
    '''
    ...
    if weights == 'imagenet':
        ...
        if include_top:
            ...
            weights_path ='nets/InceptionV4/checkpoints/inception-v4_weights_tf_dim_ordering_tf_kernels_notop.h5'
